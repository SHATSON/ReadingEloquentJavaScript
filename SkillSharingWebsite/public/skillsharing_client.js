...
function renderTalkForm(dispatch) {
    ...
    }, elt("h3", null, "Submit a Talk"), elt("label", null, "Title: ", title), 
        elt("label", null, "Summary: ", summary), elt("button", {type: "submit"}, "Submit"));
}
    ...
    for (;;) {
        ...
        try {
            response = await fetchOK("/talks", {
                headers: tags && {"If-None-Match": tag, "Prefer": "wait=90"}
            });
        } catch (e) {
