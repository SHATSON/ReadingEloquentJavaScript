...
class PixelEditor {
    constructor(state, config) {
        ...
        this.controls = controls.map("br"), ...this.controls.reduce((a, c) => a.concat(" ", c.dom), []));
    }
    syncState(state) {
        this.state = state;
